...
//	IOLibrary::print("getline:");
//	getline_example();

//	IOLibrary::print("read:");
//	read_example();

//	IOLibrary::print("get + gcount");
//	gcount_example();

//	IOLibrary::print("ignore example");
//	ignore_basic_example();

	IOLibrary::print("ignore useful example");
